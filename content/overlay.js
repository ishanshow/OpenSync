...
const OpenSyncOverlay = (function () {
    ...
    const icons = {
        logo: `<svg ${SVG_NS} width="18" height="18" viewBox="0 0 28 28" fill="none"><path d="M8 6L20 14L8 22V6Z" fill="currentColor" opacity="0.3"/><path d="M8 6L20 14L8 22V6Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M4 10C4 5.58 7.58 2 12 2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M24 18C24 22.42 20.42 26 16 26" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`,
