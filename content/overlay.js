...
const OpenSyncOverlay = (function () {
    ...
    const icons = {
        logo: `<svg ${SVG_NS} width="18" height="18" viewBox="100 120 824 784" fill="none"><path d="M 177 571 A 340 340 0 0 1 731 252" stroke="currentColor" stroke-width="46" stroke-linecap="round"/><path d="M 847 453 A 340 340 0 0 1 293 772" stroke="currentColor" stroke-width="46" stroke-linecap="round"/><path d="M 703 312 L 807 329 Q 827 332 820 313 L 786 214 Q 779 195 766 210 L 696 294 Q 683 309 703 312 Z" fill="currentColor"/><path d="M 321 712 L 217 695 Q 197 692 204 711 L 238 810 Q 245 829 258 814 L 328 730 Q 341 715 321 712 Z" fill="currentColor"/><path d="M 410 380 Q 410 330 453 355 L 687 487 Q 730 512 687 537 L 453 670 Q 410 695 410 645 Z" fill="currentColor"/></svg>`,
